...
- Privacy: public policy is aligned with the local-first app posture, optional iCloud sync, HealthKit, optional TelemetryDeck analytics, support email, Cloudflare hosting/security processing, Buttondown launch-update email processing, and no journal-content server access.
